        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-4 group">
            <div className="relative">
              ...
              <div className="relative w-14 h-14 rounded-full bg-linear-to-br from-gray-200 via-gray-400 to-gray-600 flex items-center justify-center text-3xl shadow-[0_0_15px_rgba(255,255,255,0.2)] border-2 border-white/50 transform group-hover:rotate-12 transition-transform">
                🥋
              </div>
            </div>
            <div>
          ...
          <div className="relative w-full md:w-96">
            <input
              ...
              className="w-full px-5 py-3 pl-12 bg-white/5 border border-white/10 rounded-2xl text-white placeholder-white/30 uppercase font-bold text-xs tracking-widest focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:bg-white/10 transition-all backdrop-blur-xl shadow-inner italic"
            />
